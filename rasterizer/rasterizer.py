                        ...
                        if xp1.size != 0:
                            while (xp1[0][0] < th[0][0] or xp1[0][0] < setup[0][0]):
                                if (xp1[0][0] < w and xp1[0][0] >=0 and xp1[0][1] < h and xp1[0][1] >= 0):
                                    ...
                                    w_val = xp1[0][3]
                                    color = [xp1[0][4], xp1[0][5], xp1[0][6]]
                                    if sRGB:
                                        color = convert_sRGB(color)
                                    new_color = (int(color[0] / w val * 255), int(color[1] / w val * 255), int(color[2] / w val * 255))
                                    if (depth): 
                        ...
                        if xp1.size != 0:
                            while (xp1[0][0] < th[0][0] or xp1[0][0] < setup[0][0]):
                                if (xp1[0][0] < w and xp1[0][0] >=0 and xp1[0][1] < h and xp1[0][1] >= 0):
                                    position = (int(xp1[0][0]), int(xp1[0][1]))
                                    w_val = xp1[0][3]
                                    color = (int(xp1[0][4] / w_val * 255), int(xp1[0][5] / w_val * 255), int(xp1[0][6] / w_val * 255))
                                    if sRGB:
                                        color = convert_sRGB(color)
                                    if (depth): 
                                        if (xp1[0][2] < depth_vals[int(xp1[0][0]), int(xp1[0][1])]):
                                            image.im.putpixel(position, color)
                                            depth_vals[int(xp1[0][0]), int(xp1[0][1])] = xp1[0][2]
                                    else:
                                        image.im.putpixel(position, color)
                                xp1[0] += xp1[1]
                    ...
                    while bh[0][1] < b[1]:
                        ...
                        if xp2.size != 0:
                            while (xp2[0][0] < bh[0][0] or xp2[0][0] < setup[0][0]):
                                if (xp2[0][0] < w and xp2[0][0] >= 0 and xp2[0][1] < h and xp2[0][1] >= 0):
                                    position = (int(xp2[0][0]), int(xp2[0][1]))
                                    color = (int(xp2[0][4] / w_val * 255), int(xp2[0][5] / w_val * 255), int(xp2[0][6] / w_val * 255))
                                    if sRGB:
                                        color = convert_sRGB(color)
                                    if (xp2[0][2] < depth_vals[int(xp2[0][0]), int(xp2[0][1])]):
                                        image.im.putpixel(position, color)
